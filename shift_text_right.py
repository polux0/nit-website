...
def add_shifted_text(img, draw, title, subtitle, shift_right=80):
    """Add text with right shift to prevent cutoff"""
    width, height = img.size
    ...
    if subtitle:
        ...
        print(f"  Subtitle positioned at ({subtitle_x}, {subtitle_y})")
...
for img_info in images_to_process:
    ...
    # Add new text shifted to the right
...
print("\n✅ All text shifted to the right successfully!")
